...
public class Sulphur1 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Sulphur1.this, Weeks.class));
        finish();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.icon_frame:
                Intent i = new Intent(Sulphur1.this,Colors.class);
                startActivity(i);
                return true;
            default:
                Intent ii = new Intent(Sulphur1.this,Colors.class);
                startActivity(ii);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sulphur1);
        ...
        yVals3.add(new BarEntry(3, 8));
        yVals4.add(new BarEntry(4, 1));
        yVals5.add(new BarEntry(5, 10));
...
//Y-axis
        ...
        five = (Button)findViewById(R.id.no2);


        one.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Sulphur1.this, PM251.class));
            }
        });
        ...
        two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Sulphur1.this, PM101.class));
            }
        });
        ...
        five.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Sulphur1.this, NO21.class));
            }
        });
        ...
        three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Sulphur1.this, O31.class));
            }
        });

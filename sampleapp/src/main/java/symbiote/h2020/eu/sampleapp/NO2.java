...
public class NO2 extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.icon_frame:
                Intent i = new Intent(NO2.this,Colors.class);
                startActivity(i);
                return true;
            default:
                Intent ii = new Intent(NO2.this,Colors.class);
                startActivity(ii);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        four.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NO2.this, Ozone.class));
            }
        });
        ...
        five.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NO2.this, Sulphur.class));
            }
        });
        ...
        for(int c = 0;c<nitrogenVienna.size();c++){

            v = nitrogenVienna.get(c);
            if(v>maxV){
                maxV = v;
            }
        ...
        for(int c = 0;c<nitrogenZagreb.size();c++){

            v3 = nitrogenZagreb.get(c);
            if(v3>maxZ){
                maxZ = v3;
            }
        ...
        for(int c = 0;c<nitrogenLimassol.size();c++){

            v6 = nitrogenLimassol.get(c);
            if(v6>maxL){
                maxL = v6;
            }

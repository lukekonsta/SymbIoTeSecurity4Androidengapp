...
public class NO23 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(NO23.this, Weeks.class));
        finish();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.icon_frame:
                Intent i = new Intent(NO23.this,Colors.class);
                startActivity(i);
                return true;
            default:
                Intent ii = new Intent(NO23.this,Colors.class);
                startActivity(ii);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_no23);
        ...
        yVals1.add(new BarEntry(1, 17));
        yVals2.add(new BarEntry(2, 9));
        yVals3.add(new BarEntry(3, 29));
        yVals4.add(new BarEntry(4, 16));
        yVals5.add(new BarEntry(5, 18));
        yVals6.add(new BarEntry(6, 16));
...
//Y-axis
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(NO23.this, PM253.class));
            }
        });
        ...
        two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NO23.this, PM103.class));
            }
        });
        ...
        five.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NO23.this, Sulphur3.class));
            }
        });
        ...
        three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NO23.this, O33.class));
            }
        });

...
public class ZagrebOzone2 extends AppCompatActivity {

    ArrayList<Float> ozoneZagreb2 = new ArrayList<Float>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zagreb_ozone2);
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(ZagrebOzone2.this);
        Type type = new TypeToken<List<String>>() {
        }.getType();


        //Sulphur - Vienna
        String json = sharedPrefs.getString("array_zagreb_ozone2", "");
        ...
        for (int counter = 0; counter < arrayList.size(); counter++) {
            ...
            ozoneZagreb2.add(final_float_total);

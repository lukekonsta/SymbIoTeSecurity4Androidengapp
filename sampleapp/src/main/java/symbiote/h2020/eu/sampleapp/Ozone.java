...
public class Ozone extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Ozone.this, Charts.class));
        finish();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.icon_frame:
                Intent i = new Intent(Ozone.this,Colors.class);
                startActivity(i);
                return true;
            default:
                Intent ii = new Intent(Ozone.this,Colors.class);
                startActivity(ii);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ozone);
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(Ozone.this);
        Type type = new TypeToken<List<String>>() {
        }.getType();


        String json12 = sharedPrefs.getString("array_vienna_ozone", "");
        ...
        String json13 = sharedPrefs.getString("array_zagreb_ozone", "");
        ...
        String json14 = sharedPrefs.getString("array_limassol_ozone", "");
        ...
        //float value1 = ozoneLimassol.get(0);

        float value2 = 0;
        float v=0;

        for(int c = 0;c<ozoneVienna.size();c++){
        ...
        for(int c = 0;c<ozoneZagreb.size();c++){

            v3 = ozoneZagreb.get(c);
            if(v3>maxZ){
                maxZ = v3;
            }
        ...
        for(int c = 0;c<ozoneLimassol.size();c++){

            v6 = ozoneLimassol.get(c);
            if(v6>maxL){
                maxL = v6;
            }
        ...
        set2 = new BarDataSet(yVals2, "Βιέννη: Χ");
        set2.setColor(Color.BLUE);
        set2.setValueTextSize(10f);
        set3 = new BarDataSet(yVals3, "Υ");
        set3.setColor(Color.BLUE);
        set3.setValueTextSize(10f);
        set4 = new BarDataSet(yVals4, "Ζάγκρεμπ: Χ");
        set4.setColor(Color.GREEN);
        set4.setValueTextSize(10f);
        set5 = new BarDataSet(yVals5, "Υ");
        set5.setColor(Color.GREEN);
        set5.setValueTextSize(10f);
        set6 = new BarDataSet(yVals6, "Λεμεσός: Χ");
        set6.setColor(Color.MAGENTA);
        set6.setValueTextSize(10f);
        set7 = new BarDataSet(yVals7, "Υ");
...
//Y-axis
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Ozone.this, Comparison.class));
            }
        });
        ...
        two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Ozone.this, PM10.class));
            }
        });
        ...
        five.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Ozone.this, Sulphur.class));
            }
        });
        ...
        three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Ozone.this, NO2.class));
            }
        });

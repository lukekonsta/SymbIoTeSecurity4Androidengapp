...
public class PM252 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(PM252.this, Weeks.class));
        finish();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.icon_frame:
                Intent i = new Intent(PM252.this,Colors.class);
                startActivity(i);
                return true;
            default:
                Intent ii = new Intent(PM252.this,Colors.class);
                startActivity(ii);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pm252);
        ...
        yVals1.add(new BarEntry(1, 19));
        yVals2.add(new BarEntry(2, 12));
        yVals3.add(new BarEntry(3, 29));
        yVals4.add(new BarEntry(4, 13));
        yVals5.add(new BarEntry(5, 18));
        yVals6.add(new BarEntry(6, 15));
...
//Y-axis
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PM252.this, NO22.class));
            }
        });
        ...
        two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PM252.this, PM102.class));
            }
        });
        ...
        five.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PM252.this, Sulphur2.class));
            }
        });
        ...
        three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PM252.this, O32.class));
            }
        });

...
public class O32 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(O32.this, Weeks.class));
        finish();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.icon_frame:
                Intent i = new Intent(O32.this,Colors.class);
                startActivity(i);
                return true;
            default:
                Intent ii = new Intent(O32.this,Colors.class);
                startActivity(ii);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_o32);
        ...
        yVals1.add(new BarEntry(1, 48));
        yVals2.add(new BarEntry(2, 16));
        yVals3.add(new BarEntry(3, 42));
        yVals4.add(new BarEntry(4, 15));
        yVals5.add(new BarEntry(5, 45));
        yVals6.add(new BarEntry(6, 17));
...
//Y-axis
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(O32.this, PM252.class));
            }
        });
        ...
        two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(O32.this, PM102.class));
            }
        });
        ...
        five.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(O32.this, Sulphur2.class));
            }
        });
        ...
        three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(O32.this, NO22.class));
            }
        });

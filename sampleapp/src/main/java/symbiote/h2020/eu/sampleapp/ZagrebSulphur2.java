...
public class ZagrebSulphur2 extends AppCompatActivity {

    ArrayList<Float> sulphurZagreb2 = new ArrayList<Float>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zagreb_sulphur2);
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(ZagrebSulphur2.this);
        Type type = new TypeToken<List<String>>() {
        }.getType();


        //Sulphur - Vienna
        String json = sharedPrefs.getString("array_zagreb_sulphur2", "");
        ...
        for (int counter = 0; counter < arrayList.size(); counter++) {
            ...
            sulphurZagreb2.add(final_float_total);
        ...
        float val3 = sulphurZagreb2.get(0);
        if (val3 <= 150) {

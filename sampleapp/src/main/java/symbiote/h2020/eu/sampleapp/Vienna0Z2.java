...
public class Vienna0Z2 extends AppCompatActivity {

    ArrayList<Float> ozone2Vienna = new ArrayList<Float>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vienna0_z2);
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(Vienna0Z2.this);
        Type type = new TypeToken<List<String>>() {
        }.getType();


        //Ozone2 - Vienna
        String json = sharedPrefs.getString("array_vienna_ozone2", "");
        ...
        for (int counter = 0; counter < arrayList.size(); counter++) {
            ...
            ozone2Vienna.add(final_float_total);

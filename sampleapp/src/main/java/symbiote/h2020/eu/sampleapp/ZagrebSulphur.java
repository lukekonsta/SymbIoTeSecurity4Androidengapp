...
public class ZagrebSulphur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zagreb_sulphur);
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(ZagrebSulphur.this);
        Type type = new TypeToken<List<String>>() {
        }.getType();


        //Sulphur - Vienna
        String json = sharedPrefs.getString("array_zagreb_sulphur", "");
        ...
        float val3 = sulphurZagreb.get(0);
        if (val3 <= 150) {

...
public class ZagrebNitrogen2 extends AppCompatActivity {

    ArrayList<Float> nitrogenZagreb2 = new ArrayList<Float>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zagreb_nitrogen2);
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(ZagrebNitrogen2.this);
        Type type = new TypeToken<List<String>>() {
        }.getType();


        //Nitrogen - Vienna
        String json = sharedPrefs.getString("array_zagreb_nitrogen2", "");
        ...
        for (int counter = 0; counter < arrayList.size(); counter++) {
            ...
            nitrogenZagreb2.add(final_float_total);
        ...
        float val3 = nitrogenZagreb2.get(0);
        if (val3 <= 100) {

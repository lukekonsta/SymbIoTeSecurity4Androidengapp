...
public class ZagrebOzone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zagreb_ozone);
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(ZagrebOzone.this);
        Type type = new TypeToken<List<String>>() {
        }.getType();


        //Sulphur - Vienna
        String json = sharedPrefs.getString("array_zagreb_ozone", "");

...
public class PM104 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(PM104.this, Weeks.class));
        finish();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.icon_frame:
                Intent i = new Intent(PM104.this,Colors.class);
                startActivity(i);
                return true;
            default:
                Intent ii = new Intent(PM104.this,Colors.class);
                startActivity(ii);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pm104);
...
//Y-axis
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PM104.this, PM254.class));
            }
        });
        ...
        two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PM104.this, NO24.class));
            }
        });
        ...
        five.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PM104.this, Sulphur4.class));
            }
        });
        ...
        three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PM104.this, O34.class));
            }
        });

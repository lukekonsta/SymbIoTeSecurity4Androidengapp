...
public class Comparison extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.icon_frame:
                Intent i = new Intent(Comparison.this,Colors.class);
                startActivity(i);
                return true;
            default:
                Intent ii = new Intent(Comparison.this,Colors.class);
                startActivity(ii);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int c = 0;c<pm25Vienna.size();c++){
        ...
        for(int c = 0;c<pm25Zagreb.size();c++){
        ...
        for(int c = 0;c<pm25Limassol.size();c++){

            v6 = pm25Limassol.get(c);
            if(v6>maxL){
                maxL = v6;
            }
...
//Y-axis
        ...
        four.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Comparison.this, Ozone.class));
            }
        });
        ...
        five.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Comparison.this, Sulphur.class));
            }
        });

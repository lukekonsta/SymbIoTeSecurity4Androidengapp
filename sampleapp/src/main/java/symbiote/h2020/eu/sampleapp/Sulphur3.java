...
public class Sulphur3 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Sulphur3.this, Weeks.class));
        finish();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.icon_frame:
                Intent i = new Intent(Sulphur3.this,Colors.class);
                startActivity(i);
                return true;
            default:
                Intent ii = new Intent(Sulphur3.this,Colors.class);
                startActivity(ii);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sulphur3);
        ...
        yVals5.add(new BarEntry(5, 6));
        yVals6.add(new BarEntry(6, 1));
...
//Y-axis
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Sulphur3.this, PM253.class));
            }
        });
        ...
        two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Sulphur3.this, PM103.class));
            }
        });
        ...
        five.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Sulphur3.this, NO23.class));
            }
        });
        ...
        three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Sulphur3.this, O33.class));
            }
        });

...
public class ViennaS022 extends AppCompatActivity {

    ArrayList<Float> sulphur2Vienna = new ArrayList<Float>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vienna_s022);
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(ViennaS022.this);
        Type type = new TypeToken<List<String>>() {
        }.getType();


        //Sulphur2 - Vienna
        String json = sharedPrefs.getString("array_vienna_sulphur2", "");
        ...
        for (int counter = 0; counter < arrayList.size(); counter++) {
            ...
            sulphur2Vienna.add(final_float_total);
        ...
        float val3 = sulphur2Vienna.get(0);
        if (val3 <= 150) {

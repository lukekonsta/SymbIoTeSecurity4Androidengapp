...
public class PM251 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(PM251.this, Weeks.class));
        finish();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.icon_frame:
                Intent i = new Intent(PM251.this,Colors.class);
                startActivity(i);
                return true;
            default:
                Intent ii = new Intent(PM251.this,Colors.class);
                startActivity(ii);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pm251);
        ...
        yVals1.add(new BarEntry(1, 29));
        yVals2.add(new BarEntry(2, 2));
        yVals3.add(new BarEntry(3, 25));
        yVals4.add(new BarEntry(4, 5));
        yVals5.add(new BarEntry(5, 25));
        yVals6.add(new BarEntry(6, 5));
...
//Y-axis
        ...
        one = (Button)findViewById(R.id.no2);
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PM251.this, NO21.class));
            }
        });
        ...
        two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PM251.this, PM101.class));
            }
        });
        ...
        five.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PM251.this, Sulphur1.class));
            }
        });
        ...
        three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PM251.this, O31.class));
            }
        });

...
public class ViennaNitro2 extends AppCompatActivity {

    ArrayList<Float> nitrogenVienna2 = new ArrayList<Float>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vienna_nitro2);
        ...
        sharedPrefs = PreferenceManager.getDefaultSharedPreferences(ViennaNitro2.this);
        Type type = new TypeToken<List<String>>() {
        }.getType();


        //Nitrogen - Vienna
        String json = sharedPrefs.getString("array_vienna_nitrogen2", "");
        ...
        for (int counter = 0; counter < arrayList.size(); counter++) {
            ...
            nitrogenVienna2.add(final_float_total);
        ...
        float val3 = nitrogenVienna2.get(0);
        if (val3 <= 100) {
